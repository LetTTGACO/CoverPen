export const iconOptions = [
  {
    ...
    tags: ["3d", "programming", "vfx", "graphic", "graphics", "game", "animation"],
    versions: {
      svg: ["original", "plain"],
      font: ["plain"],
    },
  ...
  },
  {
    ...
    versions: {
      svg: ["original", "plain", "line", "original-wordmark", "plain-wordmark", "line-wordmark"],
  ...
  },
  {
    name: "framework7",
    altnames: [],
    tags: ["framework", "cross-platform", "development", "mobile", "android", "ios", "open-source"],
    versions: {
      svg: ["original", "original-wordmark"],
      font: ["original", "original-wordmark"],
    },
  ...
  },
  {
    ...
    versions: {
      svg: ["original", "original-wordmark", "plain-wordmark", "line", "line-wordmark"],
  ...
  },
  {
    ...
    tags: ["framework", "big data", "open-source", "software", "library", "framework", "java"],
    versions: {
      svg: ["original", "original-wordmark", "plain", "plain-wordmark"],
      font: ["plain", "plain-wordmark"],
    },
  ...
  {
    name: "lumen",
    altnames: ["Laravel Lumen", "Lumen Laravel", "Laravel Lumen Framework", "laravel.lumen"],
  ...
  },
  {
    ...
    tags: ["nodejs", "javascript", "js", "microservices", "micro-services", "framework"],
    versions: {
      svg: ["original", "original-wordmark"],
      font: ["original", "original-wordmark"],
    },
  ...
  },
  {
    name: "netlify",
    altnames: [],
    tags: ["cloud hosting", "serverless", "dynamic websites", "web applications", "open-source"],
    versions: {
      svg: ["original", "original-wordmark", "plain", "plain-wordmark"],
      font: ["plain", "plain-wordmark"],
    },
  ...
  },
  {
    name: "nhibernate",
    altnames: [],
    tags: ["library", "dotnet", ".net", "object-relational mapper", "orm", "C#", "c-sharp"],
    versions: {
      svg: ["original-wordmark", "original", "plain-wordmark", "plain", "line", "line-wordmark"],
      font: ["plain-wordmark", "plain", "line", "line-wordmark"],
    },
    color: "#903a36",
    aliases: [],
  ...
  },
  {
    name: "opencl",
    altnames: [],
    tags: ["framework", "language", "heterogeneous-computing", "cpp", "api", "khronos", "programming"],
    versions: {
      svg: ["original", "plain", "line"],
      font: ["plain", "line"],
    },
  ...
  },
  {
    ...
    tags: ["framework", "build", "web", "web-development", "development", "elixir"],
    versions: {
      svg: ["original", "original-wordmark", "plain-wordmark"],
      font: ["original", "plain-wordmark"],
    },
